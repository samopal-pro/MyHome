...
class Adafruit_SPITFT : public Adafruit_GFX {
    ...
    public:
        ...
        Adafruit_SPITFT(uint16_t w, uint16_t h, SPI1Class *spiClass, int8_t _CS, int8_t _DC, int8_t _RST = -1);
	...
	*/
    ...
    protected:
	SPI1Class *_spi;         ///< The SPI device we want to use (set in constructor)
