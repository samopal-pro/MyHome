...
Adafruit_ILI9341::Adafruit_ILI9341(SPI1Class *spiClass, int8_t cs, int8_t dc, int8_t rst) : Adafruit_SPITFT(ILI9341_TFTWIDTH, ILI9341_TFTHEIGHT, spiClass, cs, dc, rst) {
}
